...
1. Enter the following comment and click the **Submit review** button.
   ...
   <img width="300" alt="Submit review button" src="https://github.com/agility100/skills-review-pull-requests3/blob/main/.github/images/submit-review-button.png?raw=true" />
